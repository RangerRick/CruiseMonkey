...
(function() {
	...
	var amentitiesListTemplate = require('./amenities.html');
	var amentityDeckTemplate = require('./deck.html');
	...
	.controller('CMAmenitiesCtrl', function($filter, $ionicFilterBar, $ionicScrollDelegate, $localStorage, $location, $log, $scope, DeckService) {
