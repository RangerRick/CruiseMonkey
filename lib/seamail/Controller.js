(function() {
	...
	.controller('CMSeamailsCtrl', function($interval, $ionicModal, $ionicPopup, $ionicScrollDelegate, $log, $q, $scope, $timeout, NewSeamail, SeamailService, SettingsService, Twitarr, UserService) {
