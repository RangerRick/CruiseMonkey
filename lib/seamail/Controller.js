(function() {
	...
	.controller('CMSeamailsCtrl', function($interval, $ionicModal, $ionicPopup, $ionicScrollDelegate, $log, $q, $rootScope, $scope, $timeout, NewSeamail, SeamailService, SettingsService, Twitarr, UserService) {
