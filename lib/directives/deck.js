...
var deckTemplate = require('./deck.html');
		...
		link: function(scope, el, attrs) {
			...
			*/
			...
			var showMarker = function() {
				...
				if (scale && mapEntry.length && image) {
					...
					if (coords) {
						...
						$timeout(function() { // eslint-disable-line @typescript-eslint/no-empty-function
			...
			var updateMap = function(deck) {
				...
				if (lowMemory) {
					scope.url = require('../decks/images/deck-' + deck + '-512.png').default;
				} else {
					scope.url = require('../decks/images/deck-' + deck + '-1024.png').default;
				}
