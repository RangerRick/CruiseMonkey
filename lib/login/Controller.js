(function() {
	...
	.controller('CMLoginCtrl', function($ionicPopup, $location, $log, $rootScope, $scope, cmHTTP, Conduct, Notifications, SettingsService, UserService) {
