...
(function () {
	...
	.config(function($stateProvider, $urlRouterProvider, $compileProvider, $ionicConfigProvider, $ionicFilterBarConfigProvider, $logProvider) {
		...
		$urlRouterProvider.otherwise('/tab/info/settings');
	...
	.run(function($cordovaCamera, Conduct, EmojiService, EventService, Notifications, $cordovaKeyboard, $ionicHistory, $log, $rootScope, $sce, $state, $window, Cordova, kv, LocalNotifications, SettingsService, Twitarr, UpgradeService, UserService) {
