...
.run(($cordovaCamera, BackgroundManager, Conduct, EmojiService, EventService, Notifications, $cordovaKeyboard, $ionicHistory, $log, $rootScope, $sce, $state, $window, Cordova, kv, LocalNotifications, SettingsService, Twitarr, UpgradeService, UserService) => {
