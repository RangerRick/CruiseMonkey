...
(function () {
	...
	.run(function($cordovaCamera, BackgroundManager, Conduct, EmojiService, EventService, Notifications, $cordovaKeyboard, $cordovaSplashscreen, $ionicHistory, $log, $rootScope, $sce, $state, $window, Cordova, kv, LocalNotifications, SettingsService, Twitarr, UpgradeService, UserService) {
