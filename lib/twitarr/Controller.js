(function() {
	...
	.controller('CMTweetCtrl', function($ionicLoading, $log, $q, $scope, $stateParams, CacheFactory, ImageViewer, SettingsService, Twitarr, UserDetail) {
	...
	.controller('CMTwitarrStreamCtrl', function($interval, $ionicActionSheet, $ionicPopup, $ionicScrollDelegate, $log, $q, $scope, $timeout, EmojiService, SettingsService, Twitarr, UserDetail, UserService, uuid4) {
		...
		var lookupUser = function(username) {
			...
			//$log.error(username + ' is not cached.');
