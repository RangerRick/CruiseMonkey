(function() {
	...
	.controller('CMTweetCtrl', function($ionicLoading, $ionicScrollDelegate, $log, $q, $scope, $stateParams, ImageViewer, SettingsService, Twitarr, UserDetail) {
	...
	.controller('CMTwitarrStreamCtrl', function($interval, $ionicActionSheet, $ionicHistory, $ionicListDelegate, $ionicLoading, $ionicPopup, $ionicScrollDelegate, $log, $q, $rootScope, $scope, $timeout, EmojiService, SettingsService, TweetEditor, Twitarr, UserCache, UserDetail, UserService, uuid4) {
