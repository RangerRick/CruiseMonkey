(function() {
	...
	.controller('CMTwitarrStreamCtrl', function($ionicHistory, $ionicLoading, $ionicPopover, $ionicScrollDelegate, $log, $q, $rootScope, $scope, $localStorage, $timeout, EmojiService, TweetEditor, Twitarr, UserCache, UserDetail, UserService) {
		...
		$scope.streamTypes = {
			...
			starred: {
				enabled: function() { return true; },
				type: 'starred',
				description: function() { return 'Starred'; },
				query: function(nextPage) {
		...
		$scope.getStreamTypes = function() {
			...
			delete types.favorite;
			return types;
		};
		$scope.getStreamType = function() {
			return $scope.$storage.streamType || defaultStreamType;
		};
