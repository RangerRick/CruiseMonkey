(function() {
	...
	.controller('CMTwitarrStreamCtrl', function($interval, $ionicActionSheet, $ionicHistory, $ionicLoading, $ionicPopup, $ionicScrollDelegate, $log, $q, $rootScope, $scope, $timeout, EmojiService, SettingsService, TweetEditor, Twitarr, UserCache, UserDetail, UserService, uuid4) {
