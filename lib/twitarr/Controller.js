(function() {
	...
	.controller('CMTwitarrStreamCtrl', function($interval, $ionicActionSheet, $ionicLoading, $ionicPopup, $ionicScrollDelegate, $log, $q, $scope, $timeout, EmojiService, SettingsService, Twitarr, UserDetail, UserService, uuid4) {
