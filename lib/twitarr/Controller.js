(function() {
	...
	.controller('CMTwitarrStreamCtrl', function($filter, $interval, $ionicActionSheet, $ionicHistory, $ionicLoading, $ionicPopover, $ionicPopup, $ionicScrollDelegate, $log, $q, $rootScope, $scope, $timeout, EmojiService, kv, SettingsService, Twitarr, UserDetail, UserService, uuid4) {
		...
		$scope.streamTypes = {
			...
			favorite: {
				type: 'favorite',
				description: function() { return 'Favorite Tweets'; },
				filter: 'favoriteTweetFilter'
			}
		};
