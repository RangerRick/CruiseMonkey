(function() {
	...
	.factory('Twitarr', function($q, $rootScope, $http, $injector, $interval, $log, $timeout, $window, $cordovaFileTransfer, $ionicPlatform, Upload, kv, Cordova, LocalNotifications, SettingsService, UserService) {
