...
(function() {
	var _deckInfo = {
		1: new CMDeck(1, [
			new CMAmenity('deck-1-vista-lounge', 'Vista Lounge', 'ion-music-note', 'Entertainment', 'The main show is three levels and seats 846 people.'),
		...
		2: new CMDeck(2, [
			new CMAmenity('deck-2-vista-lounge', 'Vista Lounge', 'ion-music-note', 'Entertainment', 'The main show is three levels and seats 846 people.'),
			...
			new CMAmenity('deck-2-vista-dining-room', 'Lower Vista Dining Room', 'ion-fork', 'Dining', 'The main dining room.')
		]),
		3: new CMDeck(3, [
			new CMAmenity('deck-3-vista-lounge', 'Vista Lounge', 'ion-music-note', 'Entertainment', 'The main show is three levels and seats 846 people.'),
			...
			new CMAmenity('deck-3-vista-dining-room', 'Upper Vista Dining Room', 'ion-fork', 'Dining', 'The main dining room.')
		]),
		7: new CMDeck(7, [
			new CMAmenity('deck-7-concierge', 'Concierge', 'ion-help-buoy', 'Ship Services', 'A concierge lounge for guests.'),
		...
		11: new CMDeck(11, [
			...
			new CMAmenity('deck-11-volleyball-court', 'Volleyball Court', 'ion-record', 'Fitness', 'The volleyball court.'),
