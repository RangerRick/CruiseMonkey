...
import { CMDeck, CMAmenity } from '../data/Model';
...
(function() {
	const _deckInfo = {
		1: new CMDeck(1, [
			...
			new CMAmenity('deck-1-info-desk', 'Info Desk', 'ion-help-buoy', 'Ship Services', 'The JoCo Cruise Info Desk is located on Deck 1 in the Atrium. Stop by for answers to all of your JoCo Cruise-related questions! Info Desk hours will be listed in the daily SeaMonkey newsletter delivered to your stateroom.'),
		...
		2: new CMDeck(2, [
			...
			new CMAmenity('deck-2-casino', 'Casino', 'cm-dice', 'Casino', 'The Nieuw Amsterdam casino, featuring bingo, slots, blackjack, craps, roulette, and Texas Hold\'em.'),
			new CMAmenity('deck-2-billboard-onboard', 'Billboard Onboard', 'ion-music-note', 'Entertainment', 'A smaller live music stage themed around 50 years of rock and roll.'),
			...
			new CMAmenity('deck-2-bb-king-test-kitchen', "B.B. King's Blues Club", 'ion-music-note', 'Entertainment', "Direct from Beale Street, B.B. King's All Stars bring the best of Memphis music to sea. From funky and fast to soulful and smooth, enjoy dancing and try specialty cocktails like the Lucille and Rock Me Baby."),
			//new CMAmenity('deck-2-queens-lounge', 'Queen\'s Lounge & Culinary Arts Center', 'ion-fork', 'Entertainment', 'A multi-purpose entertainment venue for music and cooking demonstrations.'),
			...
			new CMAmenity('deck-2-art-gallery', 'Art Gallery', 'ion-images', 'Shopping', 'The Nieuw Amsterdam has a dedicated art gallery in which pieces are displayed and guests can preview works prior to auctions.'),
			...
			new CMAmenity('deck-2-microsoft-studio', 'Microsoft Studio', 'ion-ios-monitor', 'Ship Services', "C'mon, nerds. As if we need someone to teach us to use computers."),
		...
		3: new CMDeck(3, [
			...
			new CMAmenity('deck-3-hudson', 'Hudson Room', 'ion-help-buoy', 'Ship Services', 'The Hudson meeting room.'),
			new CMAmenity('deck-3-half-moon', 'Half Moon Room', 'ion-help-buoy', 'Ship Services', 'The Half Moon meeting room.'),
			new CMAmenity('deck-3-stuyvesant', 'Stuyvesant Room', 'ion-help-buoy', 'Ship Services', 'The Stuyvesant meeting room.'),
			...
			new CMAmenity('deck-3-ocean-bar', 'Ocean Bar', 'ion-wineglass', 'Bar', 'Surrounding the atrium on Promenade Deck, The Ocean Bar has seating and a piano.'),
			new CMAmenity('deck-3-photo-gallery', 'Photo Shop', 'ion-images', 'Shopping', 'In addition to offering souvenir photos taken by the ship\'s photographers, Nieuw Amsterdam has a portrait studio that seeks to create artistic photos of the sitters.'),
			new CMAmenity('deck-3-game-library', 'Game Library', 'cm-dice', 'Entertainment', 'Located on the upper floor of the Main Dining Room (Deck 3), the JoCo Cruise Game Library is stocked with a multitude of games from our own permanent library, games provided by our sponsors, and games that attendees have agreed to loan out from their own personal collections. Come try something old, something new, something borrowed, or something not even released yet!'),
		...
		9: new CMDeck(9, [
			...
			new CMAmenity('deck-9-greenhouse-spa', 'The Greenhouse Spa & Salon', 'ion-leaf', 'Fitness', 'The Greenhouse Spa features beauty and wellness rituals including facials and hot stone massages. Amongst its features are a beautiful hyrdrotherapy pool and a thermal suite with ceramic heated chairs and steam rooms.'),
			new CMAmenity('deck-9-lido-pool', 'Lido Pool', 'ion-waterdrop', 'Pool', 'Nieuw Amsterdam\'s main swimming area, The Lido Pool, is protected by a retractable glass roof and has three whirlpools.'),
			...
			new CMAmenity('deck-9-canaletto', 'Canaletto Restaurant', 'ion-fork', 'Dining', 'Canaletto is Nieuw Amsterdam\'s informal Italian specialty restaurant.'),
			...
			new CMAmenity('deck-9-new-york-pizza', 'New York Pizza', 'ion-fork', 'Dining', 'At New York Pizza, choose from a variety of scrumptious, 9-inch, thin-crust pies. Named for New York\'s famed five boroughs, our signature pizzas are made to order and topped with only the finest ingredients. Culinary Council member Ethan Stowell has also contributed signature pizza recipes to the menu. Enjoy your pizza by day while overlooking the Lido pool, and into the night.'),
		...
		11: new CMDeck(11, [
			new CMAmenity('deck-11-crows-nest', 'Crow\'s Nest (Fore)', undefined, undefined, 'The Crow\'s Nest Lounge at the top of the ship offers 270 degree panoramic views.  In the evening, it has a small stage and a dance floor.'),
			new CMAmenity('deck-11-explorations-cafe', 'Explorations Central & Café (Fore)', 'ion-wineglass', 'Bar', 'The Explorations Café was designed with the sophisticated traveler in mind.  It combines a library, Internet center, game area and a specialty coffee bar.'),
			new CMAmenity('deck-11-the-retreat', 'The Retreat (Fore)', undefined, undefined, 'An outdoor area that is perfect for guests looking for a quieter, more luxurious place to rejuvenate during their cruise.  It includes private cabanas, lounge chairs, sun beds and an exclusive bar.'),
			// new CMAmenity('deck-11-observation-deck', 'Observation Deck', undefined, undefined, 'The observation deck.'),
			new CMAmenity('deck-11-tamarind', 'Tamarind (Aft)', 'ion-fork', 'Dining', 'Praised by Condé Nast Traveler for cuisine "that rivals the top restaurants on land," Tamarind is the perfect place to explore the culinary traditions of Southeast Asia, China and Japan. The menu, which honors the elements of water, wood, fire and earth, features such exotic fare as wok-seared lobster, barramundi (Asian sea bass) in banana leaf and sushi, accompanied by chilled or heated sake. And, try our specialty sushi created in collaboration with Culinary Council member and Master Sushi Chef, Andy Matsuda.'),
			new CMAmenity('deck-11-basketball-court', 'Basketball Court (Aft)', 'ion-ios-basketball', 'Fitness', 'The basketball court.')
		])
	};
	...
	.factory('DeckService', function($log) {
		...
		return {
			...
			getAmenities: function() {
				let amenities = [];
				for (const key in _deckInfo) {
					const deck = _deckInfo[key];
					amenities.push(deck);
			...
			getAmenity: function(deck, id) {
				...
				const amenities = _deckInfo[deck].getAmenities();
