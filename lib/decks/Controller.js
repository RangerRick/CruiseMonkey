...
for (let deck=1, len=11; deck <= len; deck++) {
	deckImageUrls['512'][deck]  = require('./images/deck-' + deck + '-512.png').default;
	deckImageUrls['1024'][deck] = require('./images/deck-' + deck + '-1024.png').default;
}
...
.controller('CMDeckListCtrl', ($document, $ionicScrollDelegate, $ionicSlideBoxDelegate, $location, $log, $q, $scope, $timeout, Cordova, kv) => {
