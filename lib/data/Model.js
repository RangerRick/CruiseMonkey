...
CMEvent.prototype.getHash = function() {
	if (this._hash === undefined) {
		this._hash = hashFunc(this.getId() + this.getSummary() + this.getDescription() + this.getLocation() + this.getStartString() + this.getEndString() + this.isOfficial()+ this.isFollowed());
	}
	return this._hash;
};
