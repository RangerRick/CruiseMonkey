...
describe('Twit-Arr Translator', () => {
	...
	describe('HTML handling', () => {
		it('return the same text when there are no entities or links', () => {
			[
				'This has no HTML.',
	...
	describe('emoji handling', () => {
		...
		it('don\'t translate :invalid: emoji', () => {
